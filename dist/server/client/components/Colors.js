...
var ColorsComponent = function (_a) {
    ...
    return core_1.jsx("div", null,
        ...
        core_1.jsx("ol", { css: styles_1.populationListStyle }, colorRanking.map(function (_a, i) {
            var color = _a.color, name = _a.name, count = _a.count;
            return core_1.jsx("li", { key: 'k' + i },
                ...
                count,
                "\u00A0",
                name === myColor ? core_1.jsx("em", null, "You") : null);
        })));
};
exports.Colors = react_redux_1.connect(function (state) { return ({ colorRanking: state.game.colorRanking, myColor: state.game.colorName }); })(ColorsComponent);
